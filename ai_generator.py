...
【受益人填「法定繼承人」vs 指定受益人】
正確事實：
- 受益人填「法定繼承人」，保險金【不計入遺產】，法定繼承人可以直接向保險公司申請理賠，不需要走遺產繼承程序
- 與指定特定人的差異：需要所有法定繼承人共同提出申請，或提供相關戶籍文件證明繼承順序，手續較麻煩，不是「走繼承程序」
- 指定特定受益人的優點：只有該名受益人出面申請，流程最簡單最快
...
【保險規劃架構與順序】
- 原則：先保大風險（死亡、大病、失能）再保小費用（小病住院）
- 保費預算建議不超過年收入 10%
- 第一階段（出社會前/剛出社會）：實支實付醫療險、癌症一次金、一年期意外險
- 第二階段（出社會後）：拉高保額 + 加重大傷病險
- 第三階段（成立家庭）：新增定期壽險（按負債+子女教養費計算）、長照或失能補強
- 第四階段（退休後）：保留實支實付、長照險；壽險可視資產情況調整
