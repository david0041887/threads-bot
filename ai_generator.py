...
【順序三：先保大風險，再保小風險（人生保障圖）】
保障規劃的優先順序：
1. 壽險（死亡風險）：家庭主要收入者優先。保額參考：家庭年支出 × 10～15年，用定期壽險覆蓋
2. 長期照顧風險：一旦失能，長期照護費用比死亡更龐大，持續數十年，是最被低估的風險
3. 重大傷病風險（重大傷病險）：台灣每2.78人就有1人一生中罹癌。重症導致收入中斷，需要一次性給付彌補
4. 醫療費用（實支實付醫療險）：住院手術雜費、自費項目補充
5. 意外風險（意外險）：保費最低，最後補齊
核心原則：不要因為意外險便宜就優先買，也不要因為儲蓄險「感覺有回本」就先買——大風險才是最可怕的

【重要知識點】
- 定期壽險有平準型（保額不變）、遞增型（保額逐年增加，適合養育子女期）、遞減型（適合房貸族）
- 重大傷病卡：台灣25人中才有1人持有，代表多數人保障嚴重不足
- 重大傷病險是「確診即給付一次性現金」，用於治療前補充收入中斷；醫療實支是治療中補貼費用
- 人身保險 2 大功能：保障 vs 儲蓄理財——現在先聊保障，儲蓄是另一個話題
